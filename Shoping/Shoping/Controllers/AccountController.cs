    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(String.Empty, "EL usuario no ha sido habilitado, debes de seguir las instrucciones del correo enciado para poder habilitar el susario.");
                }
                else
                {
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(String.Empty, "Debes ingresar una contrase;a diferente.");
                    return View(model); 
                }
                User? user = await _userHelper.GetUserAsync(User.Identity.Name);
                if (user != null)
