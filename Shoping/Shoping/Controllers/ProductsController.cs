...
namespace Shoping.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Categories = await _combosHelper.GetComboCategoriasAsync(),
            };
            return View(model);
        }
        ...
        public async Task<IActionResult> Create(CreateProductViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                product.ProductCategories = new List<ProductCategory>()
                {
                    new ProductCategory
                    {
                        Category = await _context.Categorias.FindAsync(model.CategoryId)
                    }
                };
            ...
            model.Categories = await _combosHelper.GetComboCategoriasAsync();
            return View(model);
        }
        ...
        public async Task<IActionResult> AddCategory(int? id)
        {
            ...
            {
                ProductId = product.Id,
                Categories = await _combosHelper.GetComboCategoriasAsync(categories),
            };
            return View(model);
        }
        ...
        public async Task<IActionResult> AddCategory(AddCategoryProductViewModel model)
        {
            ...
            model.Categories = await _combosHelper.GetComboCategoriasAsync(categories);
            return View(model);
        }
